...
import paypal2 from "../../../../public/assets/images/paypal.png";
...
const CheckoutPage = () => {
  ...
  const payPaypal = async () => {
    try {
      let { data: { url }, status } = await axios.post(`/payment/paypal/${cartItems.id}`, JSON.stringify({}),
        {
      ...
      alert(`It had ocurred an error: ${error}`);
    }
  }
  ...
  const payStripe = async () => {
   ...
   axios.post('https://api.stripe.com/v1/payment_methods',
     Object.keys(card)
          ...
          <div className="checkout-form">
            <Form onSubmit={handleSubmit(onSubmit)}>
              <Row>
                ...
                <Col lg="6" sm="12" xs="12">
                  {cartItems && cartItems.products.length > 0 > 0 ? (
                      ...
                      <div className="order-box">
                        ...
                        <ul className="qty">
                          {cartItems.products.map((item, index) => (
                            <li key={index}>
                              {item.title} × {item.productCart.quantity}{" "}
                              <span>
                                {symbol}
                                {item.price}
                              </span>
                      ...
                      <div className="payment-box">
                        ...
                        {cartTotal !== 0 ? (
                          <div className="text-right">
                            {payment === "stripe" ? (
                              <button onClick={() => pay(payment)} className="btn-solid btn">
                                Pay with Stripe
                              </button>
                            ) : (
                              /*  <PayPalButton
