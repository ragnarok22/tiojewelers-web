                                        ...
                                        <Table className="table">
                                            ...
                                            <tbody id="table-compare">
                                                ...
                                                <tr>
                                                    ...
                                                    {compareItem.map((item, i) =>
                                                        <td className="item-row" key={i}><img src={item.photos.length > 0 && item.photos[0].path || defaultImage} alt=""
                                                ...
                                                <tr>
                                                    ...
                                                    {compareItem.map((item, i) =>
                                                        <td className="item-row" key={i}>
                                                            <p className="description-compare">{ReactHtmlParser(item.description)}</p>
                                                        </td>
                                                    )}
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td className="available-stock" key={i}>
                                                        <p>{item.quantity >= 0 ? 'Not Available' : 'Available'}</p>
                                                    </td>
                                                    )}
                                                </tr>
                                            </tbody>
